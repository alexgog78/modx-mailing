...
$_lang[$prefix . '_err_remove'] = 'Произошла ошибка при удалении';
$_lang[$prefix . '_err_nf'] = 'Запись не найдена';
$_lang[$prefix . '_err_ns'] = 'Запись не определена';
$_lang[$prefix . '_err_response'] = 'Неверный формат ответа';
$_lang[$prefix . '_err_action'] = 'Дейсвие не найдено: "[[+action]]"';
$_lang[$prefix . '_err_create'] = 'Ошибка создания записи';
