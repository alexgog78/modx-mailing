...
Ext.extend(Mailing.grid.log, MODx.grid.Grid, {
    initComponent: function () {
        this.tbar = this.getToolbar();
        this.viewConfig = Ext.applyIf(this.config.viewConfig, {
            getRowClass: this.getRowClass
        });
        Mailing.grid.log.superclass.initComponent.call(this);
    },
    ...
    _createRecord: function (btn, e) {
        MODx.loadPage('mgr/log/create', 'namespace=mailing');
    },

    _updateRecord: function (btn, e) {
        MODx.loadPage('mgr/log/update', 'namespace=mailing&id=' + this.menu.record.id);
    },
